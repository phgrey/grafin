...
from examples.stem_markdown_processor.utils.markdown_formatter import format_chunk_to_markdown, format_document_summary
...
def save_results_node(state: GraphState) -> Dict[str, Any]:
    ...
    output_dir = config.get("output_dir", "examples/stem_markdown_processor/data/results")
