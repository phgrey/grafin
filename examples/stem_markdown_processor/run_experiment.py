...
from examples.stem_markdown_processor.phase4_schedule_agent_experiment import run_phase_4
...
def main():
    ...
    # Phase 4: Google Antigravity SDK Schedule Agents (Reader & Writer)
    ...
    summary_text = (
        ...
        "4. [bold blue]Phase 4 (Google Antigravity SDK Schedule Agents)[/bold blue]: GraphinReader walked graph & inspected schedules; GraphinWriter scheduled crontab tasks & updated checkpoint state.\n\n"
