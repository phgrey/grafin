...
class IFrameworkAdapter(ABC):
    """Abstract Base Interface for framework adapters (LangGraph, CrewAI, Semantic Kernel, GraphInYAML)."""

    @property
    @abstractmethod
    def framework_name(self) -> str:
        """Return the target framework identifier (e.g. 'langgraph', 'crewai', 'semantic_kernel', 'graphin_yaml')."""
        pass
